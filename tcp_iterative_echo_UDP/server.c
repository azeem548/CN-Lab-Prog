...
/*OUTPUT:
compilation : cc –o cout tcp_client.c
	         cc –o sout tcp_itrsrv_echo.c 
execution : ./sout 10.2.0.3  5080  (server terminal)
	     ./cout 10.2.0.3  5080  (client terminal) …(for 3 times)*/

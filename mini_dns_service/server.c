...
/*OUTPUT:
compilation :	cc –o cout dnsClient.c
		cc –o sout dnsServer.c
execution :	./sout 10.2.0.3  5080 (Execute server first and in terminal 1)
		./cout 10.2.0.3  5080 (Execute client second and in terminal 2)*/
